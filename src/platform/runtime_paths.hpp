...
canonicalOrAbsolute(const std::filesystem::path& parPath) {
...
public:
  explicit RuntimePaths(const std::filesystem::path& parExecutablePath);
  ...
  getProjectPath(const std::filesystem::path& parRelativePath) const;
  [[nodiscard]] std::filesystem::path
  getAssetPath(const std::filesystem::path& parRelativePath) const;
  [[nodiscard]] std::filesystem::path
  getTexturePath(const std::filesystem::path& parRelativePath) const;
